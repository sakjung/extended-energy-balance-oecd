...
datafolder <- "group_assignment/"

filesinfolder <- list.files(datafolder)
```

```{r Filename check, results='hide'}
...
1. There is an unnecessary empty folder ("secondstudygroup")
...
#Assign NA values and changing columns order as shown in the assignment sheet
